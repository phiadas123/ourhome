...
create table if not exists public.rooms (
  ...
  household_id uuid not null references public.households on delete cascade,
  name text not null,
  sections text[] not null default array['Furniture','Appliances','Storage','Decor','Miscellaneous'],
...
begin
  ...
  insert into public.rooms (household_id, name, position) values
    (new_id, 'Living room', 0), (new_id, 'Kitchen', 1), (new_id, 'Bedroom', 2);
  return new_id;
end; $$;
